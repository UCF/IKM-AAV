...
<div id="wrapper">
	...
	<div id="navigation">
		...
		<ul class="menu">
				...
				<li><a href="<?= site_url('/main/data_main') ?>"><strong>Data</strong></a>
				<li></li>
				<?php if ($this->ion_auth->in_group($admin_group)){ ?> <li><a href="<?= site_url('auth') ?>"><strong>User Management</strong></a></li>
				<?php } ?>
				<li><a href="https://ucf.qualtrics.com/jfe/form/SV_01jaCS0xBimdgIR" target="_blanK"><strong>Feedback</strong></a></li>
